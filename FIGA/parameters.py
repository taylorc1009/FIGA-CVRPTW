...
MAX_SIMULTANEOUS_MUTATIONS: Final[int]=1 #3
...
MUTATION_SWAP_PROBABILITY: Final[int]=50 # used by TWBS
MUTATION_MAX_FBS_SWAPS: Final[int]=1 #3 # used by FBS
MUTATION_MAX_LDHR_SWAPS: Final[int]=1 #3 # used by LDHR
...
MUTATION_MAX_SLICE_LENGTH: Final[int]=3 #5 # used by PBS