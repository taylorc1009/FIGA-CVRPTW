...
PBR_CROSSOVER_MAX_VEHICLES: Final[int]=2
...
MUTATION_SWAP_PROBABILITY: Final[int]=50
MUTATION_FEASIBLE_SWAP_PROBABILITY: Final[int]=50
MUTATION_MAX_FEASIBLE_SWAPS: Final[int]=5
MUTATION_ELIMINATE_SHORTEST_PROBABILITY: Final[int]=10
MUTATION_THREATENED_WINDOW_PROBABILITY: Final[int]=20
MUTATION_MAX_SLICE_LENGTH: Final[int]=4